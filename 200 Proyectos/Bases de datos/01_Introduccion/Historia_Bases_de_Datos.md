...
| **1970s** | **Modelo Relacional** | **E.F. Codd** propone el [[Modelo_Relacional_Conceptos]] basado en tablas. Nace el concepto de independencia de datos. Ver [[Reglas_de_Codd]]. |
| **1980s** | **Dominio Relacional (SQL)** | Estandarización de [[SQL_DDL]]. Aparición de los grandes SGBD comerciales (Oracle, DB2). |

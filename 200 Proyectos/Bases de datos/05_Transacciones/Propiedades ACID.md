...
2.  **Consistencia (Consistency):** La transacción lleva a la base de datos de un estado válido a otro, cumpliendo todas las [[Restricciones (Constraints) en SQL|restricciones]].

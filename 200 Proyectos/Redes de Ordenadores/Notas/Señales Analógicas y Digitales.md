...
- **Señal Analógica**: Varía suavemente.
  - *Analogía*: Un disco de vinilo o un reloj de agujas que se mueve sin saltos.
  - *Ejemplo*: El sonido de un violín.
...
- **Periodo ($T$)**: Tiempo entre repeticiones ($T = 1/f$).
